...
pets = ['dog', 'cat', 'bunny']
for pet in pets:
    print(f"A {pet.title()} is a fun pet to have!")
print("Any of these pets can be very friendly!")
...
print(f"\n Hello {guest_list[0]}, {guest_list[1]} and {guest_list[2]}, I'd like 
      to inform that I found a bigger table and we'll be having more guests 
      joining us.\n")
